...
The **Agent Framework Dev Project** is a community initiative providing materials for instructor-led, hands-on, developer-focused training for building AI agents using modern frameworks and tooling.
...
Unless otherwise noted, repositories in this organization are released under open-source licenses (typically MIT for code, CC-BY for content).
...
* X/Twitter: [@agent_framework](https://x.com/agent_framework)

---

*The Agent Framework Dev Project is an independent community initiative.*
